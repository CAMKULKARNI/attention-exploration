...
| Exp 3: GTA + ALiBi (24 Layers)     | 0.0345 | 0.0725 | 0.1877 | 0.5097 |
| Exp 4: GQA + RoPE (28 Layers)      | 0.0419 | 0.1152 | 0.2142 | 0.6131 |
| Exp 5: GQA + RoPE (30 Layers)      | 0.0683 | 0.1619 | 0.3188 | 0.5661 |
| Exp 6: GTA + ALiBi (28 Layers)     | 0.0362 | 0.0815 | 0.2147 | 0.5796 |
| Exp 7: GTA + ALiBi (30 Layers)     | 0.0405 | 0.0901 | 0.2215 | 0.6194 |
...
| Exp 12: GGTA + ALiBi (24 Layers)   | 0.0313 | 0.1587 | 0.182  | 0.4925 |
| Exp 13: GGTA + ALiBi (28 Layers)   | 0.0426 | 0.1857 | 0.2168 | 0.5705 |
| Exp 14: GGTA + ALiBi (30 Layers)   | 0.0474 | 0.1578 | 0.2588 | 0.5957 |
...
| Exp 3: GTA + ALiBi (24 Layers)     | 0.006  | 0.0062 | 0.007  | 0.0081 |
| Exp 4: GQA + RoPE (28 Layers)      | 0.0074 | 0.0083 | 0.0085 | 0.009  |
| Exp 5: GQA + RoPE (30 Layers)      | 0.0084 | 0.0085 | 0.0088 | 0.0098 |
| Exp 6: GTA + ALiBi (28 Layers)     | 0.0063 | 0.0064 | 0.0075 | 0.0095 |
| Exp 7: GTA + ALiBi (30 Layers)     | 0.0064 | 0.0081 | 0.0079 | 0.0094 |
...
| Exp 12: GGTA + ALiBi (24 Layers)   | 0.0059 | 0.0059 | 0.006  | 0.0067 |
| Exp 13: GGTA + ALiBi (28 Layers)   | 0.0062 | 0.0064 | 0.0068 | 0.0072 |
| Exp 14: GGTA + ALiBi (30 Layers)   | 0.0068 | 0.0075 | 0.0079 | 0.0077 |
...
| Exp 3: GTA + ALiBi (24 Layers)     | 676.443 | 702.919 | 1159.81 | 2400.31 |
| Exp 4: GQA + RoPE (28 Layers)      | 637.441 | 805.757 | 1148.56 | 2124.55 |
| Exp 5: GQA + RoPE (30 Layers)      | 680.759 | 805.757 | 1143.56 | 2138.05 |
| Exp 6: GTA + ALiBi (28 Layers)     | 612.759 | 724.757 | 1160.13 | 2392.05 |
| Exp 7: GTA + ALiBi (30 Layers)     | 642.601 | 790.757 | 1076.39 | 2423.89 |
...
| Exp 12: GGTA + ALiBi (24 Layers)   | 790.284 | 823.283 | 1147.97 | 2106.91 |
| Exp 13: GGTA + ALiBi (28 Layers)   | 668.441 | 853.757 | 1223.56 | 2114.32 |
| Exp 14: GGTA + ALiBi (30 Layers)   | 694.759 | 850.007 | 1218.56 | 2120.57 |
...
| Exp 3: GTA + ALiBi (24 Layers)     | 328.39M  |
| Exp 4: GQA + RoPE (28 Layers)      | 359.86M  |
| Exp 5: GQA + RoPE (30 Layers)      | 381.89M  |
| Exp 6: GTA + ALiBi (28 Layers)     | 374.54M  |
| Exp 7: GTA + ALiBi (30 Layers)     | 397.62M  |
...
| Exp 12: GGTA + ALiBi (24 Layers)   | 309.51M  |
| Exp 13: GGTA + ALiBi (28 Layers)   | 352.52M  |
| Exp 14: GGTA + ALiBi (30 Layers)   | 374.03M  |